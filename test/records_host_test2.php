...
/* ★★★ 修改重點：圓餅圖數據分佈 (大部分是 Fail) ★★★ */
.pie-chart {
    width: 70px;
    height: 70px;
    border-radius: 50%;
    /* Fail (灰) 佔 60%, Pass (淺藍) 30%, High (深藍) 10% */
...
.tag-fail { top: 10px; left: 15px; } /* 左上：變成大宗 */
    ...
    <div class="content-container">
        <div class="white-card">
            ...
            <div class="card-header">
                <h1 class="quiz-title">TEST 2 (FAILED)</h1>
            ...
            <div class="chart-section-top">
                ...
                <div class="bar-chart-wrap">
                    <div class="bar" style="height: 85%;"><div class="bar-label">&lt;60</div></div>
                    <div class="bar" style="height: 40%;"><div class="bar-label">60-70</div></div>
                    <div class="bar" style="height: 20%;"><div class="bar-label">70-80</div></div>
                    <div class="bar" style="height: 10%;"><div class="bar-label">80-90</div></div>
                    <div class="bar" style="height: 5%;"><div class="bar-label">90+</div></div>
                </div>
                ...
                <div class="stats-text">
                    ...
                    <div class="stat-row">
                        ...
                        <span class="stat-value">2HR 10MIN</span>
                    </div>
                    <div class="stat-row">
                        <span class="stat-label">FAILED:</span>
                        <span class="stat-value" style="color:#5d6d7e;">25 PPL</span>
                    </div>
                </div>
            </div>
            ...
            <div class="chart-section-bottom">
                ...
                <div class="pie-tag tag-fail">60% FAIL</div>
                <div class="pie-tag tag-pass">30% PASS</div>
                <div class="pie-tag tag-high">10% HIGH</div>
            </div>
